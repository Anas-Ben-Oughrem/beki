...
public class EmailConstant {
    ...
    public static final String USERNAME = "fincroesprit@gmail.com";
    public static final String PASSWORD = "fincroesprit123";
    public static final String FROM_EMAIL = "support@fincro.com";
